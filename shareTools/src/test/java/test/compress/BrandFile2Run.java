 ...
 */
public class BrandFile2Run {
	public static void main(String[] args) {
		new BrandFile2Run().run(null);
	}
	...
	public void run(Map<String, Object> map) {
		// 日志文件路径
		String logPath = "C:\\Users\\Administrator\\Desktop\\LoseLogs\\GuiJi";
		...
		// 读取源路径
		String srcPath = "C:\\Users\\Administrator\\Desktop\\Rar";
		// 读取目标路径
		String descPath = "C:\\Users\\Administrator\\Desktop\\GuiJi";
		// 在路径后添加/或\\
		...
		try {
			...
			if (srcFiles.length != descFiles.length) {
				for (File sf : srcFiles) {
					...
					if (!exists) {
						msg += fileName + "\t归集rar打包文件缺失" + FileUtil.LINE_SEPARATOR;
					}
				}
			}
			if (!"".equals(msg)) {
