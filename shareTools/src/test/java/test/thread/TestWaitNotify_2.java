...
public class TestWaitNotify_2 extends Thread {
	private WidgetMaker maker;

	public TestWaitNotify_2(String name, WidgetMaker maker) {
		super(name);
		this.maker = maker;
	}
	...
	public void run() {
		...
		System.out.println(w + "," + getName() + "got a widget");
	}

	public static void main(String[] args) {
		WidgetMaker maker = new WidgetMaker();
		maker.start();
		new TestWaitNotify_2("Lenny", maker).start();
		new TestWaitNotify_2("Moe", maker).start();
		new TestWaitNotify_2("Curly", maker).start();
