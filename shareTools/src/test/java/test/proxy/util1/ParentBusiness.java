...
public abstract class ParentBusiness implements InvocationHandler {
	private Object target;

	public ParentBusiness(Object target) {
		this.target = target;
	}
	 ...
	 * 接口中的proxy参数不能用于调用所实现接口的方法。奇怪的是hashCode()和getClass
	 * ()方法都是从Object中继承下来的方法，为什么一个可以另一个不可以呢
	 * ？带首疑问到doc文档看一下Object中这两个方法，发现getClass()是定义为final的，而
