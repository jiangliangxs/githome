...
public class GBKGetFirstLetter {
	...
	public static void main(String args[]) {
		System.out.println(UTF8GetFirstLetter.getFirstLetter("中国人"));
		System.out.println(UTF8GetFirstLetter.getFirstLetter("净利润增长率"));
		System.out.println(UTF8GetFirstLetter.getFirstLetter("流通股"));
	}
}